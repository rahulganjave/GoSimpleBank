postgres:
	docker run --name postgres14.5 -p 5432:5432 -e POSTGRES_USER=root -e POSTGRES_PASSWORD=secretkey -d postgres:14.5-alpine
...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/gosimplebank/db/sqlc Store
